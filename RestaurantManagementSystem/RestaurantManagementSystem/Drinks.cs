    ...
    public partial class Drinks : UserControl
    {
        ...
        private void btnCustSubmit_Click(object sender, EventArgs e)
        {
            try {
                ...
                Dat AB = new Dat();
                AB.A = "INSERT INTO OrderedFood(Customer_Name, Food_Type,Price,Food,Quantity,Table_Number) VALUES('" + txtCustName.Text + "','Drinks','"+txtprice.Text+"','" + comboBox1.Text + "','" + txtCustQnty.Text + "','" + txtCustTable.Text + "')";
                AB.insert(AB.A);
